...
const cases = {
  ...
  ZH: [
    ...
    { no: "02", market: "海湾地区", sector: "海湾供应链", text: "面向海湾市场的项目与运营需求，协调从供应商寻源、采购到交付的跨境供应链执行。", points: ["供应商寻源", "采购协调", "建材 / FF&E / 工业供应", "物流与交付协调", "跨境供应链执行"] },
