...
const COUNTRIES_DATA: CountryRecord[] = [
  ...
  },
  {
    ...
    nameZH: "泰国",
    nameAR: "تايلاند",
    descEN: "Southeast Asia network coverage market. Strategic sourcing and distribution network — not in daily policy monitoring.",
    descZH: "东南亚网络覆盖市场。战略性采购与分销网络，不纳入每日政策监控。",
    descAR: "سوق تغطية شبكة جنوب شرق آسيا. شبكة مصادر وتوزيع استراتيجية — غير مشمول بالرصد اليومي.",
    tagsEN: ["Network Coverage", "Sourcing", "Distribution"],
    tagsZH: ["网络覆盖", "采购网络", "分销支持"],
    tagsAR: ["تغطية الشبكة", "المصادر", "التوزيع"],
    image: null
  },
  {
    key: "morocco",
