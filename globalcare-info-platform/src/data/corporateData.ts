...
export const LANGUAGES: Record<"EN" | "ZH" | "AR", LanguagePack> = {
  EN: {
    ...
    contactTitle: "START A BUSINESS CONVERSATION",
    contactSubtitle: "Connect with GCI to discuss market entry, project opportunities, supply requirements, workforce needs or business execution support.",
  ...
  AR: {
    ...
    contactTitle: "ابدأ محادثة عمل معنا",
    contactSubtitle: "تواصل مع GCI لمناقشة دخول السوق، أو فرص المشاريع، أو متطلبات التوريد، أو احتياجات القوى العاملة، أو دعم تنفيذ الأعمال.",
    ...
    contactFormSubmit: "إرسال الاستفسار",
