...
const BASE_LANGUAGES: Record<Exclude<LanguageCode, "ES">, LanguagePack> = {
  EN: {
    ...
    navContact: "Contact",
    contactBtn: "Talk to GCI",
    
    heroBadge: "Cross-Border Business Execution Platform",
    heroTitle: "Global Resources.\nGLOBAL EXECUTION.",
    heroSubtitle: "Connecting businesses, markets and execution capabilities across China, the Middle East, Africa and Europe.",
    heroDesc: "GCI helps companies enter new markets, build local partnerships, execute cross-border projects and transform business operations through technology and AI.",
    heroCtaPrimary: "Explore Our Capabilities",
    heroCtaSecondary: "Discuss a Market Entry",
    ...
    whoWeAreDesc1: "GCI is a Dubai-based global business execution platform connecting companies, projects, resources and workforce across the Middle East, Africa, Asia and selected global markets.\n\nWe combine local market knowledge, commercial networks and cross-border execution capabilities to help businesses enter markets, connect resources and move opportunities into execution.",
    whoWeAreDesc2: "Our strength comes from practical execution.\n\nThrough local execution, commercial networks and resource coordination, GCI helps businesses achieve market entry and project delivery across regional and global markets.",
    whoWeAreTargetTitle: "Who We Serve",
    whoWeAreTargets: ["Manufacturers & Suppliers", "Brand Owners & Enterprises", "Project Developers & Contractors", "Trading & Supply Chain Companies", "Employers & Project Operators", "Strategic & Local Partners"],
    ...
    contactTitle: "WHERE ARE YOU EXPANDING NEXT?",
    contactSubtitle: "Choose a direction and talk to GCI about the market, partners, resources and operating capabilities required to move forward.",
    contactFormName: "Contact Name",
    contactFormEmail: "Business Email",
    contactFormCompany: "Company Name",
    contactFormCorridor: "Inquiry Type",
    contactFormMsg: "Tell Us What You Need",
    contactFormSubmit: "Talk to GCI",
  ...
  ZH: {
    ...
    heroBadge: "跨境商业执行平台",
    heroTitle: "Global Resources.\nGLOBAL EXECUTION.",
    heroSubtitle: "连接中国、中东、非洲与欧洲的企业、市场和执行能力。",
    heroDesc: "GCI 帮助企业进入新市场、建立本地伙伴关系、执行跨境项目，并通过技术与 AI 重构企业运营。",
    heroCtaPrimary: "探索核心能力",
    heroCtaSecondary: "沟通市场进入",
    heroHoverTip: "鼠标悬停在主要区域，查看 GCI 双边在岸服务走廊",
    
    whoWeAreLabel: "关于GCI",
    whoWeAreTitle: "本土认知。\n区域网络。\n在岸执行。",
    whoWeAreDesc1: "GCI 是一家以迪拜为枢纽的全球商业执行平台，连接企业、项目、供应链资源与国际劳动力，覆盖中东、非洲、亚洲及部分全球市场。\n\n我们结合本地市场经验、商业网络与跨境执行能力，帮助企业进入市场、连接资源，并推动商业机会真正落地。",
    whoWeAreDesc2: "我们的优势源于务实的执行力。\n\n通过本地执行、商业网络与资源协调，GCI 协助企业实现市场进入与项目交付，覆盖区域及全球市场。",
    whoWeAreTargetTitle: "服务对象",
    whoWeAreTargets: ["制造商与供应商", "品牌方与企业", "项目开发商与承包商", "贸易与供应链企业", "雇主与项目运营方", "战略与本地合作伙伴"],
    ...
    contactLabel: "联系商务团队",
    contactTitle: "您的下一站市场在哪里？",
    contactSubtitle: "选择业务方向，与 GCI 沟通进入市场所需的伙伴、资源和执行能力。",
    contactFormName: "联系人姓名",
    contactFormEmail: "企业邮箱",
    contactFormCompany: "公司名称",
    contactFormCorridor: "咨询类型",
    contactFormMsg: "请告诉我们您的需求",
    contactFormSubmit: "联系 GCI",
  ...
  AR: {
    ...
    navContact: "اتصل بنا",
    contactBtn: "تحدث مع GCI",
    
    heroBadge: "منصة تنفيذ الأعمال العابرة للحدود",
    heroTitle: "Global Resources.\nGLOBAL EXECUTION.",
    heroSubtitle: "ربط الشركات والأسواق وقدرات التنفيذ عبر الصين والشرق الأوسط وأفريقيا وأوروبا.",
    heroDesc: "تساعد GCI الشركات على دخول أسواق جديدة وبناء شراكات محلية وتنفيذ مشاريع عابرة للحدود وتحويل العمليات من خلال التكنولوجيا والذكاء الاصطناعي.",
    heroCtaPrimary: "استكشف قدراتنا",
    heroCtaSecondary: "ناقش دخول السوق",
    ...
    whoWeAreDesc1: "GCI هي منصة تنفيذ أعمال عالمية مقرها دبي، تربط الشركات والمشاريع والموارد والقوى العاملة عبر الشرق الأوسط وأفريقيا وآسيا وأسواق عالمية مختارة.\n\nنحن نجمع بين المعرفة بالسوق المحلية والشبكات التجارية وقدرات التنفيذ عبر الحدود لمساعدة الشركات على دخول الأسواق وربط الموارد وتحويل الفرص إلى تنفيذ فعلي.",
    whoWeAreDesc2: "قوتنا تكمن في التنفيذ العملي.\n\nمن خلال التنفيذ المحلي والشبكات التجارية وتنسيق الموارد، تساعد GCI الشركات على تحقيق دخول الأسواق وتسليم المشاريع عبر الأسواق الإقليمية والعالمية.",
    whoWeAreTargetTitle: "من نخدمهم",
    whoWeAreTargets: ["الشركات المصنعة والموردون", "أصحاب العلامات التجارية والمؤسسات", "مطورو المشاريع والمقاولون", "شركات التجارة وسلسلة الإمداد", "أصحاب العمل ومشغلو المشاريع", "الشركاء الاستراتيجيون والمحليون"],
    ...
    contactTitle: "إلى أين تتوسع بعد ذلك؟",
    contactSubtitle: "اختر اتجاهاً وتحدث مع GCI حول السوق والشركاء والموارد والقدرات التشغيلية المطلوبة.",
    contactFormName: "الاسم الكريم",
    contactFormEmail: "البريد الإلكتروني المهني",
    contactFormCompany: "اسم المؤسسة / المصنع",
    contactFormCorridor: "نوع الاستفسار",
    contactFormMsg: "أخبرنا بما تحتاجه",
    contactFormSubmit: "تحدث مع GCI",
